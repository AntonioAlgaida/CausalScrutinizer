...
2.  **Dynamic Analysis (Frame-by-Frame):** Describe the actions of the Magenta AV and any other relevant agents, noting their movement relative to the "Ego-Up" perspective. **Crucially, for any Pedestrians or Cyclists, you must state their approximate location relative to the AV and the nearest crosswalk.**
...
"""
    ...
    # --- 5. Run Inference ---
    print("\n--- Sending final V11 prompt to LM Studio server... ---")
    try:
        ...
        print(f"\n❌ ERROR: Could not connect to the LM Studio server. Details: {e}")
